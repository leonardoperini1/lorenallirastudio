...
import logoFull from "@/assets/ll-logo-full.png";
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 bg-background/95 backdrop-blur-md border-b border-foreground/5">
      <div className="mx-auto flex h-24 max-w-[1440px] items-center px-6 md:px-10 lg:px-16 relative">
        <a href="#inicio" className="flex items-center group" aria-label="Lorena LLira — Criação Musical">
          <img src={logoFull} alt="Lorena LLira — Criação Musical" className="h-16 md:h-20 w-auto shrink-0" />
        </a>
