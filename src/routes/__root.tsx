...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Atelier de composições autorais sob medida — transforme sentimentos em música." },
      { name: "author", content: "Lorena LLira" },
      { property: "og:title", content: "Lorena LLira" },
      { property: "og:description", content: "Composições autorais personalizadas, gravadas em estúdio." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lorena Llira" },
      { name: "twitter:description", content: "Transformando sua imaginação em arte" },
